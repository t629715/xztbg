...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: this.api + "userInfo/selectByRegisterMessage",
      ...
      exportUrl: this.api + "userInfo/excelRegisterMessage",
      editUrl: this.api + "userInfo/updateRegisterStatusById",
      provinceUrl: this.api + "userInfo/getByAttributionPro",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
...
var update = __webpack_require__(198)("7b0f28d6", content, true);

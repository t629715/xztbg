...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: this.api + "goldRedeem/selectByGoldRedeem",
      channelUrl: this.api + "user/selectByChannelMessage",
      exportUrl: this.api + "goldRedeem/excelGoldRedeem",
      countUrl: this.api + "goldRedeem/selectByGoldRedeemCount",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
...
var update = __webpack_require__(198)("44cf0f2d", content, true);

...
// module
exports.push([module.i, ".el-row[data-v-7aa126f3]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-7aa126f3]{border-radius:4px}.bg-purple-dark[data-v-7aa126f3]{background:#99a9bf}.bg-purple[data-v-7aa126f3]{background:#d3dce6}.bg-purple-light[data-v-7aa126f3]{background:#e5e9f2}.grid-content[data-v-7aa126f3]{border-radius:4px;min-height:36px}.row-bg[data-v-7aa126f3]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("7c903bca", content, true);

...
// module
exports.push([module.i, ".el-row[data-v-6b6a9e0a]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-6b6a9e0a]{border-radius:4px}.bg-purple-dark[data-v-6b6a9e0a]{background:#99a9bf}.bg-color1[data-v-6b6a9e0a]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-6b6a9e0a]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-6b6a9e0a]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-6b6a9e0a]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-6b6a9e0a]{background:#d3dce6}.bg-purple-light[data-v-6b6a9e0a]{background:#e5e9f2}.gridBox[data-v-6b6a9e0a]{padding-left:20px}.grid-content[data-v-6b6a9e0a]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.row-bg[data-v-6b6a9e0a]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("ced1df2a", content, true);

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      actorUrl: "role/selectByRoleAll",
      addUrl: "user/insertUser",
      editUrl: "user/updateUser",
      ...
      rules: {
        ...
        actor: [{ required: true, message: '请输入角色名', trigger: 'blur' }]
      }
    };
  },
  //页面渲染加载方法
  ...
  methods: {
    ...
    confirmAdd(formName) {
      ...
      params.append('rids', this.newform.actor);
      let _this = this;
    ...
    confirmAddEdit() {
      ...
      console.log(this.newformEdit.actor);
      var params = new URLSearchParams();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.newform.actor),
      callback: function($$v) {
        _vm.$set(_vm.newform, "actor", $$v)
      },
      expression: "newform.actor"
    }
...
var update = __webpack_require__(198)("7e10a58d", content, true);

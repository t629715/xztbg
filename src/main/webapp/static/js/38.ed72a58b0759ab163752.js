  ...
  created() {
    ...
    axios.post(this.countUrl).then(function (response) {
      if (response.data.code == 1001) {
        document.getElementById("czjeId").innerText = _this.amountHandle1(response.data.data.rmbAmtSum);
      }
    }).catch(function (error) {
      console.log(error);
    });
    ...
    handelData(list) {
      if (list.length > 0) {
        for (var i = 0; i < list.length; i++) {
          list[i].RMBAmt = this.amountHandle1(list[i].RMBAmt);
          if (list[i].RechargeChannel == "01") {
            list[i].RechargeChannel = '银联';
          } else if (list[i].RechargeChannel == "02") {
            list[i].RechargeChannel = '微信';
          } else if (list[i].RechargeChannel == "03") {
            list[i].RechargeChannel = '支付宝';
          }
        }
      }
    },
...
// module
exports.push([module.i, ".el-row[data-v-0ca8fc3e]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-0ca8fc3e]{border-radius:4px}.bg-purple-dark[data-v-0ca8fc3e]{background:#99a9bf}.bg-color1[data-v-0ca8fc3e]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-0ca8fc3e]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-0ca8fc3e]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-0ca8fc3e]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-0ca8fc3e]{background:#d3dce6}.bg-purple-light[data-v-0ca8fc3e]{background:#e5e9f2}.gridBox[data-v-0ca8fc3e]{padding-left:20px}.grid-content[data-v-0ca8fc3e]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.row-bg[data-v-0ca8fc3e]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("594eebcf", content, true);

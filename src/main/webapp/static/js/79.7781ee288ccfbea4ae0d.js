...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: this.api + "userVoucherFinance/selectByUserVoucherFinance",
      ...
      exportUrl: this.api + "userVoucherFinance/excelUserVoucherFinance",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
  ...
  methods: {
    ...
    onSubmit(sform) {
      ...
      if (sform.useStartTime != "") {
        date3 = this.dateFormat(sform.useStartTime);
      }
      if (sform.useEndTime != "") {
        date4 = this.dateFormat(sform.useEndTime);
      }
      ...
      params.append('useStartTime', date3);
      params.append('useEndTime', date4);
      params.append('userName', sform.userName);
      params.append('useStatus', sform.useStatus);
    ...
    loadData(pageSize, pageNum) {
      ...
      if (this.sform.useStartTime != "") {
        date3 = this.dateFormat(this.sform.useStartTime);
      }
      if (this.sform.useEndTime != "") {
        date4 = this.dateFormat(this.sform.useEndTime);
      }
      ...
      params.append('useStatus', this.sform.useStatus);
    ...
    handelData(list) {
      if (list.length > 0) {
        for (var i = 0; i < list.length; i++) {
          list[i].deductionPercent = this.isNotEmpty(list[i].deductionPercent) ? Number(list[i].deductionPercent) * 100 + '%' : 0;
          //list[i].deductionValue = this.amountHandle1(list[i].deductionValue);
          if (list[i].useStatus == "0") {
            list[i].useStatus = '未使用';
          } else if (list[i].useStatus == "1") {
            list[i].useStatus = '已使用';
          }
        }
      }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.sform.useStartTime),
      callback: function($$v) {
        _vm.$set(_vm.sform, "useStartTime", $$v)
      },
      expression: "sform.useStartTime"
    }
  })], 1)], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "prop": "useEndTime"
    ...
    model: {
      value: (_vm.sform.useEndTime),
      callback: function($$v) {
        _vm.$set(_vm.sform, "useEndTime", $$v)
      },
      expression: "sform.useEndTime"
    }
  })], 1)], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "状态：",
    ...
    model: {
      value: (_vm.sform.useStatus),
      callback: function($$v) {
        _vm.$set(_vm.sform, "useStatus", $$v)
      },
      expression: "sform.useStatus"
    }
  ...
  }), _vm._v(" 卡券记录")]), _vm._v(" "), _c('a', {
    staticClass: "current",
    attrs: {
      "href": "javascript:;"
    }
  }, [_vm._v("加息券")])]), _vm._v(" "), _c('h1')])
}]}
...
var update = __webpack_require__(198)("464d0684", content, true);

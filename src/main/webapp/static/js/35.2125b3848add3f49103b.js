...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: "goldIncomeRecord/selectByGoldIncome",
      agentUrl: "user/selectByAgentMessage",
      brokeUrl: "user/selectByBrokerMessage",
      exportUrl: "goldIncomeRecord/excelGoldIncome",
      countUrl: "goldIncomeRecord/selectByGoldIncomeCount",
      gramCountUrl: "goldIncomeRecord/selectByGoldGramCount",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
  ...
  created() {
    ...
    axios.get(this.gramCountUrl).then(function (response) {
      if (response.data.code == 1001) {
        document.getElementById("hjzzId").innerText = _this.amountHandle1(response.data.data.goldSum);
      }
    }).catch(function (error) {
      console.log(error);
    });
...
var update = __webpack_require__(198)("5f8a5b69", content, true);

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: "userInfo/selectByRealNameAuth",
      cerfiUrl: "userInfo/certification",
      currentPage: 1,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
...
// module
exports.push([module.i, ".el-row[data-v-6aec31b0]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-6aec31b0]{border-radius:4px}.bg-purple-dark[data-v-6aec31b0]{background:#99a9bf}.bg-purple[data-v-6aec31b0]{background:#d3dce6}.bg-purple-light[data-v-6aec31b0]{background:#e5e9f2}.grid-content[data-v-6aec31b0]{border-radius:4px;min-height:36px}.row-bg[data-v-6aec31b0]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("232e0e96", content, true);

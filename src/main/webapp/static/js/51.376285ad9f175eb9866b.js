...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: "inVestGoldOrder/selectByAll",
      agentUrl: "user/selectByAgentMessage",
      brokeUrl: "user/selectByBrokerMessage",
      brokerUrl1: "user/selectByBrokerMessage1",
      exportUrl: "inVestGoldOrder/excelAll",
      countUrl: "inVestGoldOrder/countByAll",
      addUrl: 'inVestGoldOrder/addLogisticsNoById',
      editUrl: 'inVestGoldOrder/updateLogisticsNoById',
      completeUrl: 'inVestGoldOrder/completeOrderById',
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: this.api + "userGoldAccountActivityRecord/selectByAll",
      ...
      exportUrl: this.api + "userGoldAccountActivityRecord/excelByAll",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
  ...
  methods: {
    ...
    onSubmit(sform) {
      ...
      params.append('activityType', sform.activityType);
    ...
    loadData(pageSize, pageNum) {
      ...
      params.append('activityType', this.sform.activityType);
      ...
      if (list.length > 0) {
        for (var i = 0; i < list.length; i++) {
          if (list[i].activityType == 1) {
            list[i].activityType = '新手活动';
          } else if (list[i].activityType == 2) {
            list[i].activityType = '推荐有礼';
          }
        }
      }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.sform.activityType),
      callback: function($$v) {
        _vm.$set(_vm.sform, "activityType", $$v)
      },
      expression: "sform.activityType"
    }
...
var update = __webpack_require__(198)("ff199b2a", content, true);

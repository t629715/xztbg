...
// module
exports.push([module.i, ".el-row[data-v-aad9e8e2]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-aad9e8e2]{border-radius:4px}.bg-purple-dark[data-v-aad9e8e2]{background:#99a9bf}.bg-color1[data-v-aad9e8e2]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-aad9e8e2]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-aad9e8e2]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-aad9e8e2]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-aad9e8e2]{background:#d3dce6}.bg-purple-light[data-v-aad9e8e2]{background:#e5e9f2}.gridBox[data-v-aad9e8e2]{padding-left:20px}.grid-content[data-v-aad9e8e2]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.row-bg[data-v-aad9e8e2]{padding:10px 0;background-color:#f9fafc}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('p', [_vm._v("盈亏总计（元）")]), _vm._v(" "), _c('p', [_vm._v(_vm._s(_vm.total.profitAndLossSum))])])])], 1), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "auto",
...
var update = __webpack_require__(198)("39b88253", content, true);

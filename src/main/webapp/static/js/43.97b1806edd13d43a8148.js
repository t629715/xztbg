...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: "userInfo/getByUserAttribute",
      agentUrl: "user/selectByAgentMessage",
      brokeUrl: "user/selectByBrokerMessage",
      exportUrl: "userInfo/excelByUserAttribute",
      countUrl: "userInfo/getByUserAttributeCount",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
...
// module
exports.push([module.i, ".el-row[data-v-0f465b42]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-0f465b42]{border-radius:4px}.bg-purple-dark[data-v-0f465b42]{background:#99a9bf}.bg-color1[data-v-0f465b42]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-0f465b42]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-0f465b42]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-0f465b42]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-0f465b42]{background:#d3dce6}.bg-purple-light[data-v-0f465b42]{background:#e5e9f2}.gridBox[data-v-0f465b42]{padding-left:20px}.grid-content[data-v-0f465b42]{height:110px;border-radius:4px;min-height:110px;text-align:center;font-size:14px}.row-bg[data-v-0f465b42]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("ab87c95a", content, true);

...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data() {
        return {
            ...
            url: "financeRegulargoldOrder/selectByFinanceOrder",
            agentUrl: "user/selectByAgentMessage",
            brokeUrl: "user/selectByBrokerMessage",
            brokerUrl1: "user/selectByBrokerMessage1",
            exportUrl: "financeRegulargoldOrder/exportFinanceOrder",
            countUrl: "financeRegulargoldOrder/selectTotalAmountBuy",
            currentPage: 0,
            pageSize: 10,
            pageNum: 1,
            totalNum: 0,
...
// module
exports.push([module.i, ".el-row[data-v-aea59eca]{margin-bottom:20px;& :last-child{margin-bottom:0}}.el-col[data-v-aea59eca]{border-radius:4px}.bg-purple-dark[data-v-aea59eca]{background:#99a9bf}.bg-color1[data-v-aea59eca]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-aea59eca]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-aea59eca]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-aea59eca]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-aea59eca]{background:#d3dce6}.bg-purple-light[data-v-aea59eca]{background:#e5e9f2}.gridBox[data-v-aea59eca]{padding-left:20px}.grid-content[data-v-aea59eca]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.row-bg[data-v-aea59eca]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("480ef80e", content, true);

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: "userInfo/getByUserAnalysis",
      agentUrl: "user/selectByAgentMessage",
      brokeUrl: "user/selectByBrokerMessage",
      exportUrl: "userInfo/excelByUserAnalysis",
      countUrl: "userInfo/getByUserAnalysisCount",
      currentPage: 0,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
  ...
  created() {
    ...
    axios.post(this.countUrl, params).then(function (response) {
      if (response.data.code == 1001) {
        ...
        document.getElementById("xrjbl").innerText = _this.isNotEmpty(xrjbl) ? Number(Number(xrjbl) * 100).toFixed(2) + '%' : 0;
        ...
        document.getElementById("xjybl").innerText = _this.isNotEmpty(xjybl) ? Number(Number(xjybl) * 100).toFixed(2) + '%' : 0;
      }
    }).catch(function (error) {
      console.log(error);
    });
    ...
    handelData(list) {
      if (list.length > 0) {
        for (var i = 0; i < list.length; i++) {
          list[i].xrjbl = this.isNotEmpty(list[i].xrjbl) ? Number(Number(list[i].xrjbl) * 100).toFixed(2) + '%' : 0;
          list[i].xjqjybl = this.isNotEmpty(list[i].xjqjybl) ? Number(Number(list[i].xjqjybl) * 100).toFixed(2) + '%' : 0;
          list[i].xhjwzbl = this.isNotEmpty(list[i].xhjwzbl) ? Number(Number(list[i].xhjwzbl) * 100).toFixed(2) + '%' : 0;
          list[i].xsycbl = this.isNotEmpty(list[i].xsycbl) ? Number(Number(list[i].xsycbl) * 100).toFixed(2) + '%' : 0;
          list[i].xswhjbl = this.isNotEmpty(list[i].xswhjbl) ? Number(Number(list[i].xswhjbl) * 100).toFixed(2) + '%' : 0;
        }
      }
    },
    //清空
...
// module
exports.push([module.i, ".el-row[data-v-457309dc]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-457309dc]{border-radius:4px}.bg-purple-dark[data-v-457309dc]{background:#99a9bf}.bg-color1[data-v-457309dc]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-457309dc]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-457309dc]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-457309dc]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-457309dc]{background:#d3dce6}.bg-purple-light[data-v-457309dc]{background:#e5e9f2}.gridBox[data-v-457309dc]{padding-left:20px}.grid-content[data-v-457309dc]{height:140px;border-radius:4px;min-height:140px;text-align:center;font-size:14px}.row-bg[data-v-457309dc]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("48b41cdb", content, true);

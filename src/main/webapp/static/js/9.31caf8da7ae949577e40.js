...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: "realGoldOrder/selectByRealGoldOrder",
      agentUrl: "user/selectByAgentMessage",
      brokeUrl: "user/selectByBrokerMessage",
      brokerUrl1: "user/selectByBrokerMessage1",
      exportUrl: "realGoldOrder/excelRealGoldOrder",
      countUrl: "realGoldOrder/selectByRealGoldCount",
      currentPage: 0,
      pageSize: 10,
      pageNum: 1,
      totalNum: 0,
  ...
  created() {
    ...
    axios.get(this.countUrl).then(function (response) {
      if (response.data.code == 1001) {
        document.getElementById("hjmrId").innerText = response.data.data.gramSum;
        document.getElementById("sxfId").innerText = _this.amountHandle1(response.data.data.feeSum);
      }
    }).catch(function (error) {
      console.log(error);
    });
    ...
    handelData(list) {
      if (list.length > 0) {
        for (var i = 0; i < list.length; i++) {
          ...
          //list[i].rmbAmount != "" ? Number(list[i].rmbAmount)/100 : 0;
          list[i].fee = this.amountHandle1(list[i].fee);
          //list[i].fee != "" ? Number(list[i].fee)/100 : 0;
...
// module
exports.push([module.i, ".el-row[data-v-1a44adb8]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-1a44adb8]{border-radius:4px}.bg-purple-dark[data-v-1a44adb8]{background:#99a9bf}.bg-color1[data-v-1a44adb8]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-1a44adb8]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-1a44adb8]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-1a44adb8]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-1a44adb8]{background:#d3dce6}.bg-purple-light[data-v-1a44adb8]{background:#e5e9f2}.gridBox[data-v-1a44adb8]{padding-left:20px}.grid-content[data-v-1a44adb8]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.row-bg[data-v-1a44adb8]{padding:10px 0;background-color:#f9fafc}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1)], 1), _vm._v(" "), _c('br'), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "注册时间：",
      "prop": "regStartTime"
    }
  ...
  }, [_c('p', [_vm._v("黄金买入总计（克）")]), _vm._v(" "), _c('p', {
    attrs: {
      "id": "hjmrId"
    }
  })])]), _vm._v(" "), _c('el-col', {
  ...
  }, [_c('p', [_vm._v("手续费总计（元）")]), _vm._v(" "), _c('p', {
    attrs: {
      "id": "sxfId"
    }
...
var update = __webpack_require__(198)("50117a15", content, true);

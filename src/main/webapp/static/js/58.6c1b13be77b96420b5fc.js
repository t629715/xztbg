      ...
      axios.get(this.getPayWayUrl).then(function (response) {
        ...
        for (var i = 0; i < list.length; i++) {
          ...
          for (var j = 0; j < list[i].payWays.length; j++) {
            ...
            } else if (list[i].payWays[j].payWay == 7) {
              if (str != "") {
                str += "，官方支付宝(1)";
              } else {
                str += "官方支付宝(1)";
              }
            } else if (list[i].payWays[j].payWay == 8) {
              if (str != "") {
                str += "，官方微信(1)";
              } else {
                str += "官方微信(1)";
              }
            } else if (list[i].payWays[j].payWay == 9) {
              if (str != "") {
                str += "，银联(1)";
              } else {
                str += "银联(1)";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("官方微信")]), _vm._v(" "), _c('el-checkbox', {
    attrs: {
      "label": "7",
      "name": "payWays"
    }
  }, [_vm._v("官方支付宝(1)")]), _vm._v(" "), _c('el-checkbox', {
    attrs: {
      "label": "8",
      "name": "payWays"
    }
  }, [_vm._v("官方微信(1)")]), _vm._v(" "), _c('el-checkbox', {
    attrs: {
      "label": "9",
      "name": "payWays"
    }
  }, [_vm._v("银联(1)")])], 1)], 1)], 1), _vm._v(" "), _c('div', {

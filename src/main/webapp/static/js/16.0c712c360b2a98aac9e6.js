...
// module
exports.push([module.i, ".el-row[data-v-0623a2e0]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-0623a2e0]{border-radius:4px}.bg-purple-dark[data-v-0623a2e0]{background:#99a9bf}.bg-purple1[data-v-0623a2e0]{background:#f2dede}.bg-purple2[data-v-0623a2e0]{background:#dff0d8}.bg-purple3[data-v-0623a2e0]{background:#d9edf7}.bg-purple4[data-v-0623a2e0]{background:#fcf8e3}.bg-purple5[data-v-0623a2e0]{background:#d3dce6}.bg-purple-light[data-v-0623a2e0]{background:#e5e9f2}.gridBox[data-v-0623a2e0]{padding-left:20px}.grid-content[data-v-0623a2e0]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.grid-content p[data-v-0623a2e0]:first-child{line-height:40px}.grid-content p[data-v-0623a2e0]:last-child{line-height:0}.row-bg[data-v-0623a2e0]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("5792abf6", content, true);

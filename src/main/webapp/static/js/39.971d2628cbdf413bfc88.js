...
/* harmony default export */ __webpack_exports__["default"] = ({
    data() {
        return {
            ...
            url: this.api + "xioude/getXioude",
            addUrl: this.api + "xioude/releaseXioude",
            editUrl: this.api + "xioude/modifyInfoXioude",
            deleteUrl: this.api + "xioude/deleteXioude",
            operatorListUrl: this.api + "xioude/getOperators",
...
var update = __webpack_require__(198)("4cce1af6", content, true);

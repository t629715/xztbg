...
// module
exports.push([module.i, ".el-row[data-v-c6f84f42]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-c6f84f42]{border-radius:4px}.bg-purple-dark[data-v-c6f84f42]{background:#99a9bf}.bg-color1[data-v-c6f84f42]{color:#da542e;border:.5px solid #da542e;background:#f2dede}.bg-color2[data-v-c6f84f42]{color:#468849;background:#dff0d8;border:.5px solid #468847}.bg-color3[data-v-c6f84f42]{color:#27a9e3;background:#d9edf7;border:.5px solid #3a87ad}.bg-color4[data-v-c6f84f42]{color:#c3881f;background:#fcf8e3;border:.5px solid #c3881e}.bg-color5[data-v-c6f84f42]{background:#d3dce6}.bg-purple-light[data-v-c6f84f42]{background:#e5e9f2}.gridBox[data-v-c6f84f42]{padding-left:20px}.grid-content[data-v-c6f84f42]{height:75px;border-radius:4px;min-height:75px;text-align:center;font-size:14px}.row-bg[data-v-c6f84f42]{padding:10px 0;background-color:#f9fafc}", ""]);
...
var update = __webpack_require__(198)("39aeb0ba", content, true);

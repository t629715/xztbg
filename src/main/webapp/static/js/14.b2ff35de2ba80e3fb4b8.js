...
/* harmony default export */ __webpack_exports__["default"] = ({
    data() {
        return {
            ...
            url: "goldRightDealConf/getAllGoldRight",
            editUrl: "goldRightDealConf/modifyGoldRightDealConf",
            forceUrl: "goldRightDealConf/force-close-repository",
            tableData: [],
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    scopedSlots: _vm._u([{
      key: "default",
      fn: function(scope) {
        return [(scope.row.status == 0 || scope.row.status == 1) ? [_c('el-button', {
          attrs: {
            "size": "small",
            "type": "danger"
          },
        ...
        }, [_vm._v("关闭交易")])] : _vm._e(), _vm._v(" "), (scope.row.status == 0 || scope.row.status == 2) ? [_c('el-button', {
          attrs: {
            "size": "small",
            "type": "primary"
          },
        ...
        }, [_vm._v("开启交易")])] : _vm._e(), _vm._v(" "), (scope.row.status == 1 || scope.row.status == 2) ? [_c('el-button', {
          attrs: {
            "size": "small",
            "type": "primary"
          },
        ...
        }, [_vm._v("正常交易")])] : _vm._e(), _vm._v(" "), _c('el-button', {
          attrs: {
            "size": "small",
            "type": "primary"
          },
...
var update = __webpack_require__(198)("34c53c67", content, true);

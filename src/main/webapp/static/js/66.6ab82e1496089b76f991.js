...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data() {
        return {
            ...
            platformNameUrl: this.api + "userRecharge/getPlatformName",
            currentPage: 0,
            pagesize: 10,
            pageNum: 1,
            totalNum: 0,
    ...
    methods: {
        ...
        onSubmit(sform) {
            ...
            params.append('PlatformName', sform.PlatformName);
        ...
        loadData(pageSize, pageNum) {
            ...
            params.append('PlatformName', this.sform.PlatformName);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.sform.PlatformName),
      callback: function($$v) {
        _vm.$set(_vm.sform, "PlatformName", $$v)
      },
      expression: "sform.PlatformName"
    }
  }, _vm._l((_vm.PlatformNameOptions), function(item) {
    return _c('el-option', {
      key: item.id,
      attrs: {
        "label": item.label,
...
var update = __webpack_require__(198)("a05f1f2a", content, true);

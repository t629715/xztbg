...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      url: this.api + "userInfo/selectByRealNameAuthApprove",
      currentPage: 1,
      pagesize: 10,
      pageNum: 1,
      totalNum: 0,
...
// module
exports.push([module.i, ".el-row[data-v-7541f472]{margin-bottom:20px;&:last-child{margin-bottom:0}}.el-col[data-v-7541f472]{border-radius:4px}.bg-purple-dark[data-v-7541f472]{background:#99a9bf}.bg-purple[data-v-7541f472]{background:#d3dce6}.bg-purple-light[data-v-7541f472]{background:#e5e9f2}.grid-content[data-v-7541f472]{border-radius:4px;min-height:36px}.row-bg[data-v-7541f472]{padding:10px 0;background-color:#f9fafc}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.sform.state),
      callback: function($$v) {
        _vm.$set(_vm.sform, "state", $$v)
      },
      expression: "sform.state"
    }
...
var update = __webpack_require__(198)("3373602d", content, true);

...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        confirmEdit() {
            ...
            params.append("stopProfitSet", (this.newformEdit.stopProfitSet / 100).toFixed(2));
            params.append("minLossPercent", (this.newformEdit.minLossPercent / 100).toFixed(2));
            params.append("minProfitPercent", (this.newformEdit.minProfitPercent / 100).toFixed(2));
...
var update = __webpack_require__(198)("f689d704", content, true);

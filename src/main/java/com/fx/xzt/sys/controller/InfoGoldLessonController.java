...
public class InfoGoldLessonController {
    ...
    */
     ...
     * @return
     */
    @RequestMapping(value="/modifyGoldLessonState")
    @ResponseBody
    public CommonResponse modifyGoldLessonState(HttpServletRequest request, Long infoId, String title, String operator, Short state){
        CommonResponse response = new CommonResponse();
        try {
            HttpSession httpSession = request.getSession();
            Users users = (Users) httpSession.getAttribute("currentUser");

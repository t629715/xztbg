        ...
        try {
            ...
            if (users != null) {
                ...
                if (list != null && list.size() > 0) {
                    ...
                    String[] heads = {"用户账号", "代理商",  "经纪人", "优惠券名称", "抵扣金额", "使用时间", "发放时间", "来源","状态"};
                    String[] colums = {"userName", "agentName", "brokerName", "description", "deductionValue", "useTime", "createTime", "source", "useStatus"};

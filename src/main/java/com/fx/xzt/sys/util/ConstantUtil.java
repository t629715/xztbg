...
public class ConstantUtil {
    ...
    *
    ...
    /**
     * 
    * @ClassName: userVoucherUseStatus 
    * @Description: 优惠券使用状态
    * @author htt
    * @date 2017-11-8 下午3:58:45 
    *
     */
    public static enum userVoucherUseStatus {
        WSY("未使用","0"),
        YSY("已使用","1");
        private String name;
        private String index;
        private userVoucherUseStatus(String name,String index){
            this.name = name;
            this.index = index;
        }
        public String toString() {
        ...
        public static Map<String, String> toMap() {
        	userVoucherUseStatus[] ds = userVoucherUseStatus.values();
            Map<String, String> rlt = new Hashtable<String, String>();
            for (userVoucherUseStatus d : ds) {
                rlt.put(d.index, d.name);
            }
            return rlt;
        }
    ...
    /**
     * 
    * @ClassName: userVoucherType 
    * @Description: 优惠券类型
    * @author htt
    * @date 2017-11-8 下午4:00:02 
    *
     */
    public static enum userVoucherType {
        ABL("按比例","1"),
        AME("按面额","2");
        private String name;
        private String index;
        private userVoucherType(String name,String index){
            this.name = name;
            this.index = index;
        }
        public String toString() {
        ...
        public static Map<String, String> toMap() {
        	userVoucherType[] ds = userVoucherType.values();
            Map<String, String> rlt = new Hashtable<String, String>();
            for (userVoucherType d : ds) {
                rlt.put(d.index, d.name);
            }
            return rlt;
        }
    ...
    /**
     * 
    * @ClassName: userVoucherFinanceUseStatus 
    * @Description: 加息券使用状态
    * @author htt
    * @date 2017-11-8 下午4:00:44 
    *
     */
    public static enum userVoucherFinanceUseStatus {
        WSY("未使用","0"),
        YSY("已使用","1");
        private String name;
        private String index;
        private userVoucherFinanceUseStatus(String name,String index){
            this.name = name;
            this.index = index;
        }
        public String toString() {
        ...
        public static Map<String, String> toMap() {
        	userVoucherFinanceUseStatus[] ds = userVoucherFinanceUseStatus.values();
            Map<String, String> rlt = new Hashtable<String, String>();
            for (userVoucherFinanceUseStatus d : ds) {
                rlt.put(d.index, d.name);
            }
            return rlt;
        }
    ...
    /**
     * 
    * @ClassName: userVoucherFinanceAddType 
    * @Description: 加息券增值类型
    * @author htt
    * @date 2017-11-8 下午4:03:38 
    *
     */
    public static enum userVoucherFinanceAddType {
        ABL("按比例","1"),
        AME("按面额","2");
        private String name;
        private String index;
        private userVoucherFinanceAddType(String name,String index){
            this.name = name;
            this.index = index;
        }
        public String toString() {
        ...
        public static Map<String, String> toMap() {
        	userVoucherFinanceAddType[] ds = userVoucherFinanceAddType.values();
            Map<String, String> rlt = new Hashtable<String, String>();
            for (userVoucherFinanceAddType d : ds) {
                rlt.put(d.index, d.name);
            }
            return rlt;
        }
